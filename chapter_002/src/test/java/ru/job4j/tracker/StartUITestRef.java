...
//        Item item4e3 = expect3.add(new Item("test_name-4", "desc_4")); //Добавляем заявку 4 в ячейку [3]
    ...
    /**
     * Тест проверяющий вывод списка заявок в консоль ("1. List of all Items").
     */
	@Test
    public void whenUserAsksListOfAllItems() {
        Tracker tracker = new Tracker();     // создаём Tracker
        Item item1a = tracker.add(new Item("test_name-1", "desc_1")); //Добавляем заявку 1 в ячейку [0]
        Item item2a = tracker.add(new Item("test_name-2", "desc_2")); //Добавляем заявку 2 в ячейку [1]
        Item item3a = tracker.add(new Item("test_name-3", "desc_3")); //Добавляем заявку 3 в ячейку [2]
        Item item4a = tracker.add(new Item("test_name-4", "desc_4")); //Добавляем заявку 4 в ячейку [3]
        ...
        assertThat(
                ...
                is(
                        new StringBuilder()
                                ...
                                .append("--------------------------------------------------")
								.append(System.lineSeparator())
								.append(" " + tracker.findAll()[0].getId() + "  |  test_name-1  |  desc_1")
								.append(System.lineSeparator())
                                .append("--------------------------------------------------")
                                .append(System.lineSeparator())
								.append(" " + tracker.findAll()[1].getId() + "  |  test_name-2  |  desc_2")
								.append(System.lineSeparator())
                                .append("--------------------------------------------------")
                                .append(System.lineSeparator())
								.append(" " + tracker.findAll()[2].getId() + "  |  test_name-3  |  desc_3")
								.append(System.lineSeparator())
                                .append("--------------------------------------------------")
                                .append(System.lineSeparator())
								.append(" " + tracker.findAll()[3].getId() + "  |  test_name-4  |  desc_4")
								.append(System.lineSeparator())
								.append("--------------------------------------------------")
								.append(System.lineSeparator())
								.append("----------------- End of list --------------------")
